...
#Random activity name generator, chiamalo cometepare \m/
...
def add_activities(petri_net, num_activities, target_place_id):
    ...
    for _ in range(num_activities):
        ...
        new_place = PetriNet.Place(f"p_{activity_name}") ############TODO genera un id casuale e fixa la gestione degli id anche sugli archi
    ...
    if next_transition:
        utils.add_arc_from_to(target_place, next_transition, petri_net)
    else:
...
########################################################################################### EXECUTION
log_intervals = [2, 22, 92, 292, 992, 2992, 9992]  #
...
def main():
    ...
    for num_activities in log_intervals:
        ...
        output_file_path = f"/home/l2brb/main/DECpietro/utils/parallel/log_scale/xor_pm4py_augmented_{num_activities + 8}.pnml"
