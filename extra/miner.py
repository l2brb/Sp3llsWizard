...
event_log = pm4py.read_xes(
    '/home/l2brb/Docker/DECpietro/test/sepsis/sepsis.xes'
    )
...
# Export to PNML
log = pm4py.write_pnml(net, im, fm, '/home/l2brb/Docker/DECpietro/test/sepsis/sepsis_alpha.pnml')

# Export pdf
pm4py.view_petri_net(net, im, fm, format='pdf')
pm4py.save_vis_petri_net(net, im, fm, file_path='/home/l2brb/Docker/DECpietro/test/sepsis/sepsis_alpha.pdf')
