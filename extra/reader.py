...
#PNML READER
net, im, fm, = pm4py.read_pnml("/home/l2brb/main/DECpietro/utils/transition_only/finegrade/xor_pm4py_augmented_16.pnml", True)

#print(net, im, fm)



#export_pm4py_pnml = pm4py.write_pnml(net, im, fm, "/home/l2brb/main/DECpietro/test/woped/pnml_simulation_pm4py.pnml")
