...
#PNML READER
net, im, fm, = pm4py.read_pnml("//Users/luca/Documents/^main/DECpietro/test/hospital.pnml", True)

#print(net, im, fm)

#export_pm4py_pnml = pm4py.write_pnml(net, im, fm, "/Users/luca/Documents/^main/DECpietro/test/PLG/pm4py/pnml_test_plg.pnml")
