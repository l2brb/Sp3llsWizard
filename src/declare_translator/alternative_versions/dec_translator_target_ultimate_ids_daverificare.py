...
# VERSIONE CON RAGGRUPPAMENTO SU TARGET E ATTIVATORE
...
#@profile
def get_alternate_precedence(workflow_net): #TODO: DEVO FIXARLO PER LE SILENT


    transition_names = {t["id"]: t.get("name", f"Unnamed_{t['id']}") for t in workflow_net["transitions"]}
        ...
        if predecessors and successors:
            ...
            for succ in successors:
                altprecedence_constraints.append({
                    ...
                    "parameters": [list(predecessors), [succ]],  # Usa ID qui
                })
