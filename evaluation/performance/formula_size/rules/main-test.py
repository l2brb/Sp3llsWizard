...
def main():
    ...
    for iteration in range(10000):
        ...
        for i in range(num__T1_applications):
        ...
        # T4a - LOOP
        updated_petri_net = rule_T4a.loop_transition_t4a(petri_net)
        ...
        output_file_path = f"/home/l2brb/main/DECpietro/utils/DTRules/out/out-complete/{iteration}.pnml"
